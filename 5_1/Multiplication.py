...
def application(environ, start_response):
    ...
    if path == '/register' and un and pw:
    ...
    elif path == '/login' and un and pw or path == '/' and un and pw:
        ...
        if user:
            ...
            elif 'f1' in params and 'f2' in params and 'an2' in params:
                if an2 == a1:
                    correct += 1
                    page += '''<!DOCTYPE html>
                    <html>
            ...
            elif 'f1' in params and 'f2' in params and 'an3' in params:
                if an3 == a1:
                    correct += 1
                    page += '''<!DOCTYPE html>
                    <html>
            ...
            elif 'f1' in params and 'f2' in params and 'an4' in params:
                if an4 == a1:
                    correct += 1
                    page += '''<!DOCTYPE html>
                    <html>
            ...
            </body></html>'''.format(int(correct), int(wrong))
